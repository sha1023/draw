...
const clearMeta = { roughness: roughness };
const redMeta = { fill: "red", roughness: roughness };
const blueMeta = { fill: "blue", roughness: roughness };
const yellowMeta = { fill: "yellow", roughness: roughness };
